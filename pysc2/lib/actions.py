...
def raw_targeted(action, action_space, ability_id, queued, commanded, target_tag):
  # Got <s2clientprotocol.raw_pb2.ActionRawUnitCommand> here
  action_cmd = action.action_raw.unit_command
  action_cmd.ability_id = ability_id
  action_cmd.unit_tags.extend(commanded)
  action_cmd.queue_command = queued
  action_cmd.target_unit_tag = target_tag
...
class Arguments(collections.namedtuple("Arguments", [
    ...
    "select_unit_id", "select_worker", "build_queue_id", "unload_id", 'raw_pos', 'commanded', 'target_tag'])):
  ...
  Attributes:
    ...
    target_tag: The tag of targeted unit
  """
  ___slots__ = ()
...
TYPES = Arguments.types(
    ...
    target_tag=ArgumentType.scalar(-1),
...
FUNCTION_TYPES = {
    ...
    raw_targeted: [TYPES.queued, TYPES.target_tag, TYPES.commanded],
}

# Which ones need an ability?
ABILITY_FUNCTIONS = {cmd_quick, cmd_screen, cmd_minimap, autocast, raw_pos, raw_quick, raw_autocast, raw_targeted}
...
_FUNCTIONS = [
    ...
    Function.ability(550, "Attack_raw_targeted", raw_targeted, 3674),
    Function.ability(551, "Attack_Attack_raw_pos", raw_pos, 23, 3674),
    Function.ability(552, "Attack_Attack_raw_targeted", raw_targeted, 23, 3674),
    Function.ability(553, "Attack_AttackBuilding_raw_pos", raw_pos, 2048, 3674),
    Function.ability(554, "Attack_AttackBuilding_raw_targeted", raw_targeted, 2048, 3674),
    Function.ability(555, "Attack_Redirect_raw_pos", raw_pos, 1682, 3674),
    Function.ability(556, "Attack_Redirect_raw_targeted", raw_targeted, 1682, 3674),
    Function.ability(557, "Scan_Move_raw_pos", raw_pos, 19, 3674),
    Function.ability(558, "Scan_Move_raw_targeted", raw_targeted, 19, 3674),
    Function.ability(559, "Behavior_BuildingAttackOff_raw_quick", raw_quick, 2082),
    Function.ability(560, "Behavior_BuildingAttackOn_raw_quick", raw_quick, 2081),
    Function.ability(561, "Behavior_CloakOff_raw_quick", raw_quick, 3677),
    Function.ability(562, "Behavior_CloakOff_Banshee_raw_quick", raw_quick, 393, 3677),
    Function.ability(563, "Behavior_CloakOff_Ghost_raw_quick", raw_quick, 383, 3677),
    Function.ability(564, "Behavior_CloakOn_raw_quick", raw_quick, 3676),
    Function.ability(565, "Behavior_CloakOn_Banshee_raw_quick", raw_quick, 392, 3676),
    Function.ability(566, "Behavior_CloakOn_Ghost_raw_quick", raw_quick, 382, 3676),
    Function.ability(567, "Behavior_GenerateCreepOff_raw_quick", raw_quick, 1693),
    Function.ability(568, "Behavior_GenerateCreepOn_raw_quick", raw_quick, 1692),
    Function.ability(569, "Behavior_HoldFireOff_raw_quick", raw_quick, 3689),
    Function.ability(570, "Behavior_HoldFireOff_Ghost_raw_quick", raw_quick, 38, 3689),
    Function.ability(571, "Behavior_HoldFireOff_Lurker_raw_quick", raw_quick, 2552, 3689),
    Function.ability(572, "Behavior_HoldFireOn_raw_quick", raw_quick, 3688),
    Function.ability(573, "Behavior_HoldFireOn_Ghost_raw_quick", raw_quick, 36, 3688),
    Function.ability(574, "Behavior_HoldFireOn_Lurker_raw_quick", raw_quick, 2550, 3688),
    Function.ability(575, "Behavior_PulsarBeamOff_raw_quick", raw_quick, 2376),
    Function.ability(576, "Behavior_PulsarBeamOn_raw_quick", raw_quick, 2375),
    Function.ability(577, "Build_Armory_raw_pos", raw_pos, 331),
    Function.ability(578, "Build_Assimilator_raw_targeted", raw_targeted, 882),
    Function.ability(579, "Build_BanelingNest_raw_pos", raw_pos, 1162),
    Function.ability(580, "Build_Barracks_raw_pos", raw_pos, 321),
    Function.ability(581, "Build_Bunker_raw_pos", raw_pos, 324),
    Function.ability(582, "Build_CommandCenter_raw_pos", raw_pos, 318),
    Function.ability(583, "Build_CreepTumor_raw_pos", raw_pos, 3691),
    Function.ability(584, "Build_CreepTumor_Queen_raw_pos", raw_pos, 1694, 3691),
    Function.ability(585, "Build_CreepTumor_Tumor_raw_pos", raw_pos, 1733, 3691),
    Function.ability(586, "Build_CyberneticsCore_raw_pos", raw_pos, 894),
    Function.ability(587, "Build_DarkShrine_raw_pos", raw_pos, 891),
    Function.ability(588, "Build_EngineeringBay_raw_pos", raw_pos, 322),
    Function.ability(589, "Build_EvolutionChamber_raw_pos", raw_pos, 1156),
    Function.ability(590, "Build_Extractor_raw_targeted", raw_targeted, 1154),
    Function.ability(591, "Build_Factory_raw_pos", raw_pos, 328),
    Function.ability(592, "Build_FleetBeacon_raw_pos", raw_pos, 885),
    Function.ability(593, "Build_Forge_raw_pos", raw_pos, 884),
    Function.ability(594, "Build_FusionCore_raw_pos", raw_pos, 333),
    Function.ability(595, "Build_Gateway_raw_pos", raw_pos, 883),
    Function.ability(596, "Build_GhostAcademy_raw_pos", raw_pos, 327),
    Function.ability(597, "Build_Hatchery_raw_pos", raw_pos, 1152),
    Function.ability(598, "Build_HydraliskDen_raw_pos", raw_pos, 1157),
    Function.ability(599, "Build_InfestationPit_raw_pos", raw_pos, 1160),
    Function.ability(600, "Build_Interceptors_raw_quick", raw_quick, 1042),
    Function.ability(601, "Build_Interceptors_raw_autocast", raw_autocast, 1042),
    Function.ability(602, "Build_LurkerDen_raw_pos", raw_pos, 1163),
    Function.ability(603, "Build_MissileTurret_raw_pos", raw_pos, 323),
    Function.ability(604, "Build_Nexus_raw_pos", raw_pos, 880),
    Function.ability(605, "Build_Nuke_raw_quick", raw_quick, 710),
    Function.ability(606, "Build_NydusNetwork_raw_pos", raw_pos, 1161),
    Function.ability(607, "Build_NydusWorm_raw_pos", raw_pos, 1768),
    Function.ability(608, "Build_PhotonCannon_raw_pos", raw_pos, 887),
    Function.ability(609, "Build_Pylon_raw_pos", raw_pos, 881),
    Function.ability(610, "Build_Reactor_raw_quick", raw_quick, 3683),
    Function.ability(611, "Build_Reactor_raw_pos", raw_pos, 3683),
    Function.ability(612, "Build_Reactor_Barracks_raw_quick", raw_quick, 422, 3683),
    Function.ability(613, "Build_Reactor_Barracks_raw_pos", raw_pos, 422, 3683),
    Function.ability(614, "Build_Reactor_Factory_raw_quick", raw_quick, 455, 3683),
    Function.ability(615, "Build_Reactor_Factory_raw_pos", raw_pos, 455, 3683),
    Function.ability(616, "Build_Reactor_Starport_raw_quick", raw_quick, 488, 3683),
    Function.ability(617, "Build_Reactor_Starport_raw_pos", raw_pos, 488, 3683),
    Function.ability(618, "Build_Refinery_raw_targeted", raw_targeted, 320),
    Function.ability(619, "Build_RoachWarren_raw_pos", raw_pos, 1165),
    Function.ability(620, "Build_RoboticsBay_raw_pos", raw_pos, 892),
    Function.ability(621, "Build_RoboticsFacility_raw_pos", raw_pos, 893),
    Function.ability(622, "Build_SensorTower_raw_pos", raw_pos, 326),
    Function.ability(623, "Build_ShieldBattery_raw_pos", raw_pos, 895),
    Function.ability(624, "Build_SpawningPool_raw_pos", raw_pos, 1155),
    Function.ability(625, "Build_SpineCrawler_raw_pos", raw_pos, 1166),
    Function.ability(626, "Build_Spire_raw_pos", raw_pos, 1158),
    Function.ability(627, "Build_SporeCrawler_raw_pos", raw_pos, 1167),
    Function.ability(628, "Build_Stargate_raw_pos", raw_pos, 889),
    Function.ability(629, "Build_Starport_raw_pos", raw_pos, 329),
    Function.ability(630, "Build_StasisTrap_raw_pos", raw_pos, 2505),
    Function.ability(631, "Build_SupplyDepot_raw_pos", raw_pos, 319),
    Function.ability(632, "Build_TechLab_raw_quick", raw_quick, 3682),
    Function.ability(633, "Build_TechLab_raw_pos", raw_pos, 3682),
    Function.ability(634, "Build_TechLab_Barracks_raw_quick", raw_quick, 421, 3682),
    Function.ability(635, "Build_TechLab_Barracks_raw_pos", raw_pos, 421, 3682),
    Function.ability(636, "Build_TechLab_Factory_raw_quick", raw_quick, 454, 3682),
    Function.ability(637, "Build_TechLab_Factory_raw_pos", raw_pos, 454, 3682),
    Function.ability(638, "Build_TechLab_Starport_raw_quick", raw_quick, 487, 3682),
    Function.ability(639, "Build_TechLab_Starport_raw_pos", raw_pos, 487, 3682),
    Function.ability(640, "Build_TemplarArchive_raw_pos", raw_pos, 890),
    Function.ability(641, "Build_TwilightCouncil_raw_pos", raw_pos, 886),
    Function.ability(642, "Build_UltraliskCavern_raw_pos", raw_pos, 1159),
    Function.ability(643, "BurrowDown_raw_quick", raw_quick, 3661),
    Function.ability(644, "BurrowDown_Baneling_raw_quick", raw_quick, 1374, 3661),
    Function.ability(645, "BurrowDown_Drone_raw_quick", raw_quick, 1378, 3661),
    Function.ability(646, "BurrowDown_Hydralisk_raw_quick", raw_quick, 1382, 3661),
    Function.ability(647, "BurrowDown_Infestor_raw_quick", raw_quick, 1444, 3661),
    Function.ability(648, "BurrowDown_InfestorTerran_raw_quick", raw_quick, 1394, 3661),
    Function.ability(649, "BurrowDown_Lurker_raw_quick", raw_quick, 2108, 3661),
    Function.ability(650, "BurrowDown_Queen_raw_quick", raw_quick, 1433, 3661),
    Function.ability(651, "BurrowDown_Ravager_raw_quick", raw_quick, 2340, 3661),
    Function.ability(652, "BurrowDown_Roach_raw_quick", raw_quick, 1386, 3661),
    Function.ability(653, "BurrowDown_SwarmHost_raw_quick", raw_quick, 2014, 3661),
    Function.ability(654, "BurrowDown_Ultralisk_raw_quick", raw_quick, 1512, 3661),
    Function.ability(655, "BurrowDown_WidowMine_raw_quick", raw_quick, 2095, 3661),
    Function.ability(656, "BurrowDown_Zergling_raw_quick", raw_quick, 1390, 3661),
    Function.ability(657, "BurrowUp_raw_quick", raw_quick, 3662),
    Function.ability(658, "BurrowUp_raw_autocast", raw_autocast, 3662),
    Function.ability(659, "BurrowUp_Baneling_raw_quick", raw_quick, 1376, 3662),
    Function.ability(660, "BurrowUp_Baneling_raw_autocast", raw_autocast, 1376, 3662),
    Function.ability(661, "BurrowUp_Drone_raw_quick", raw_quick, 1380, 3662),
    Function.ability(662, "BurrowUp_Hydralisk_raw_quick", raw_quick, 1384, 3662),
    Function.ability(663, "BurrowUp_Hydralisk_raw_autocast", raw_autocast, 1384, 3662),
    Function.ability(664, "BurrowUp_Infestor_raw_quick", raw_quick, 1446, 3662),
    Function.ability(665, "BurrowUp_InfestorTerran_raw_quick", raw_quick, 1396, 3662),
    Function.ability(666, "BurrowUp_InfestorTerran_raw_autocast", raw_autocast, 1396, 3662),
    Function.ability(667, "BurrowUp_Lurker_raw_quick", raw_quick, 2110, 3662),
    Function.ability(668, "BurrowUp_Queen_raw_quick", raw_quick, 1435, 3662),
    Function.ability(669, "BurrowUp_Queen_raw_autocast", raw_autocast, 1435, 3662),
    Function.ability(670, "BurrowUp_Ravager_raw_quick", raw_quick, 2342, 3662),
    Function.ability(671, "BurrowUp_Ravager_raw_autocast", raw_autocast, 2342, 3662),
    Function.ability(672, "BurrowUp_Roach_raw_quick", raw_quick, 1388, 3662),
    Function.ability(673, "BurrowUp_Roach_raw_autocast", raw_autocast, 1388, 3662),
    Function.ability(674, "BurrowUp_SwarmHost_raw_quick", raw_quick, 2016, 3662),
    Function.ability(675, "BurrowUp_Ultralisk_raw_quick", raw_quick, 1514, 3662),
    Function.ability(676, "BurrowUp_Ultralisk_raw_autocast", raw_autocast, 1514, 3662),
    Function.ability(677, "BurrowUp_WidowMine_raw_quick", raw_quick, 2097, 3662),
    Function.ability(678, "BurrowUp_Zergling_raw_quick", raw_quick, 1392, 3662),
    Function.ability(679, "BurrowUp_Zergling_raw_autocast", raw_autocast, 1392, 3662),
    Function.ability(680, "Cancel_raw_quick", raw_quick, 3659),
    Function.ability(681, "Cancel_AdeptPhaseShift_raw_quick", raw_quick, 2594, 3659),
    Function.ability(682, "Cancel_AdeptShadePhaseShift_raw_quick", raw_quick, 2596, 3659),
    Function.ability(683, "Cancel_BarracksAddOn_raw_quick", raw_quick, 451, 3659),
    Function.ability(684, "Cancel_BuildInProgress_raw_quick", raw_quick, 314, 3659),
    Function.ability(685, "Cancel_CreepTumor_raw_quick", raw_quick, 1763, 3659),
    Function.ability(686, "Cancel_FactoryAddOn_raw_quick", raw_quick, 484, 3659),
    Function.ability(687, "Cancel_GravitonBeam_raw_quick", raw_quick, 174, 3659),
    Function.ability(688, "Cancel_LockOn_raw_quick", raw_quick, 2354, 3659),
    Function.ability(689, "Cancel_MorphBroodlord_raw_quick", raw_quick, 1373, 3659),
    Function.ability(690, "Cancel_MorphGreaterSpire_raw_quick", raw_quick, 1221, 3659),
    Function.ability(691, "Cancel_MorphHive_raw_quick", raw_quick, 1219, 3659),
    Function.ability(692, "Cancel_MorphLair_raw_quick", raw_quick, 1217, 3659),
    Function.ability(693, "Cancel_MorphLurker_raw_quick", raw_quick, 2333, 3659),
    Function.ability(694, "Cancel_MorphLurkerDen_raw_quick", raw_quick, 2113, 3659),
    Function.ability(695, "Cancel_MorphMothership_raw_quick", raw_quick, 1848, 3659),
    Function.ability(696, "Cancel_MorphOrbital_raw_quick", raw_quick, 1517, 3659),
    Function.ability(697, "Cancel_MorphOverlordTransport_raw_quick", raw_quick, 2709, 3659),
    Function.ability(698, "Cancel_MorphOverseer_raw_quick", raw_quick, 1449, 3659),
    Function.ability(699, "Cancel_MorphPlanetaryFortress_raw_quick", raw_quick, 1451, 3659),
    Function.ability(700, "Cancel_MorphRavager_raw_quick", raw_quick, 2331, 3659),
    Function.ability(701, "Cancel_MorphThorExplosiveMode_raw_quick", raw_quick, 2365, 3659),
    Function.ability(702, "Cancel_NeuralParasite_raw_quick", raw_quick, 250, 3659),
    Function.ability(703, "Cancel_Nuke_raw_quick", raw_quick, 1623, 3659),
    Function.ability(704, "Cancel_SpineCrawlerRoot_raw_quick", raw_quick, 1730, 3659),
    Function.ability(705, "Cancel_SporeCrawlerRoot_raw_quick", raw_quick, 1732, 3659),
    Function.ability(706, "Cancel_StarportAddOn_raw_quick", raw_quick, 517, 3659),
    Function.ability(707, "Cancel_StasisTrap_raw_quick", raw_quick, 2535, 3659),
    Function.ability(708, "Cancel_Last_raw_quick", raw_quick, 3671),
    Function.ability(709, "Cancel_HangarQueue5_raw_quick", raw_quick, 1038, 3671),
    Function.ability(710, "Cancel_Queue1_raw_quick", raw_quick, 304, 3671),
    Function.ability(711, "Cancel_Queue5_raw_quick", raw_quick, 306, 3671),
    Function.ability(712, "Cancel_QueueAddOn_raw_quick", raw_quick, 312, 3671),
    Function.ability(713, "Cancel_QueueCancelToSelection_raw_quick", raw_quick, 308, 3671),
    Function.ability(714, "Cancel_QueuePasive_raw_quick", raw_quick, 1831, 3671),
    Function.ability(715, "Cancel_QueuePassiveCancelToSelection_raw_quick", raw_quick, 1833, 3671),
    Function.ability(716, "Effect_Abduct_raw_targeted", raw_targeted, 2067),
    Function.ability(717, "Effect_AdeptPhaseShift_raw_pos", raw_pos, 2544),
    Function.ability(718, "Effect_AntiArmorMissile_raw_targeted", raw_targeted, 3753),
    Function.ability(719, "Effect_AutoTurret_raw_pos", raw_pos, 1764),
    Function.ability(720, "Effect_BlindingCloud_raw_pos", raw_pos, 2063),
    Function.ability(721, "Effect_Blink_raw_pos", raw_pos, 3687),
    Function.ability(722, "Effect_Blink_Stalker_raw_pos", raw_pos, 1442, 3687),
    Function.ability(723, "Effect_ShadowStride_raw_pos", raw_pos, 2700, 3687),
    Function.ability(724, "Effect_CalldownMULE_raw_pos", raw_pos, 171),
    Function.ability(725, "Effect_CalldownMULE_raw_targeted", raw_targeted, 171),
    Function.ability(726, "Effect_Cancel_raw_quick", raw_quick, 3707),
    Function.ability(727, "Effect_CausticSpray_raw_targeted", raw_targeted, 2324),
    Function.ability(728, "Effect_Charge_raw_targeted", raw_targeted, 1819),
    Function.ability(729, "Effect_Charge_raw_autocast", raw_autocast, 1819),
    Function.ability(730, "Effect_ChronoBoost_raw_targeted", raw_targeted, 261),
    Function.ability(731, "Effect_ChronoBoostEnergyCost_raw_targeted", raw_targeted, 3755),
    Function.ability(732, "Effect_Contaminate_raw_targeted", raw_targeted, 1825),
    Function.ability(733, "Effect_CorrosiveBile_raw_pos", raw_pos, 2338),
    Function.ability(734, "Effect_EMP_raw_pos", raw_pos, 1628),
    Function.ability(735, "Effect_Explode_raw_quick", raw_quick, 42),
    Function.ability(736, "Effect_Feedback_raw_targeted", raw_targeted, 140),
    Function.ability(737, "Effect_ForceField_raw_pos", raw_pos, 1526),
    Function.ability(738, "Effect_FungalGrowth_raw_pos", raw_pos, 74),
    Function.ability(739, "Effect_GhostSnipe_raw_targeted", raw_targeted, 2714),
    Function.ability(740, "Effect_GravitonBeam_raw_targeted", raw_targeted, 173),
    Function.ability(741, "Effect_GuardianShield_raw_quick", raw_quick, 76),
    Function.ability(742, "Effect_Heal_raw_targeted", raw_targeted, 386),
    Function.ability(743, "Effect_Heal_raw_autocast", raw_autocast, 386),
    Function.ability(744, "Effect_HunterSeekerMissile_raw_targeted", raw_targeted, 169),
    Function.ability(745, "Effect_ImmortalBarrier_raw_quick", raw_quick, 2328),
    Function.ability(746, "Effect_ImmortalBarrier_raw_autocast", raw_autocast, 2328),
    Function.ability(747, "Effect_InfestedTerrans_raw_pos", raw_pos, 247),
    Function.ability(748, "Effect_InjectLarva_raw_targeted", raw_targeted, 251),
    Function.ability(749, "Effect_InterferenceMatrix_raw_targeted", raw_targeted, 3747),
    Function.ability(750, "Effect_KD8Charge_raw_pos", raw_pos, 2588),
    Function.ability(751, "Effect_KD8Charge_raw_targeted", raw_targeted, 2588),
    Function.ability(752, "Effect_LockOn_raw_targeted", raw_targeted, 2350),
    Function.ability(753, "Effect_LockOn_raw_autocast", raw_autocast, 2350),
    Function.ability(754, "Effect_LocustSwoop_raw_pos", raw_pos, 2387),
    Function.ability(755, "Effect_MassRecall_raw_pos", raw_pos, 142),
    Function.ability(756, "Effect_MassRecall_raw_pos_2", raw_pos, 3686),
    Function.ability(757, "Effect_MassRecall_Mothership_raw_targeted", raw_targeted, 2368, 3686),
    Function.ability(758, "Effect_MassRecall_MothershipCore_raw_targeted", raw_targeted, 1974, 3686),
    Function.ability(759, "Effect_MassRecall_Nexus_raw_pos", raw_pos, 3757, 3686),
    Function.ability(760, "Effect_MedivacIgniteAfterburners_raw_quick", raw_quick, 2116),
    Function.ability(761, "Effect_NeuralParasite_raw_targeted", raw_targeted, 249),
    Function.ability(762, "Effect_NukeCalldown_raw_pos", raw_pos, 1622),
    Function.ability(763, "Effect_OracleRevelation_raw_pos", raw_pos, 2146),
    Function.ability(764, "Effect_ParasiticBomb_raw_targeted", raw_targeted, 2542),
    Function.ability(765, "Effect_PhotonOvercharge_raw_targeted", raw_targeted, 2162),
    Function.ability(766, "Effect_PointDefenseDrone_raw_pos", raw_pos, 144),
    Function.ability(767, "Effect_PsiStorm_raw_pos", raw_pos, 1036),
    Function.ability(768, "Effect_PurificationNova_raw_pos", raw_pos, 2346),
    Function.ability(769, "Effect_Repair_raw_targeted", raw_targeted, 3685),
    Function.ability(770, "Effect_Repair_raw_autocast", raw_autocast, 3685),
    Function.ability(771, "Effect_Repair_Mule_raw_targeted", raw_targeted, 78, 3685),
    Function.ability(772, "Effect_Repair_Mule_raw_autocast", raw_autocast, 78, 3685),
    Function.ability(773, "Effect_Repair_RepairDrone_raw_targeted", raw_targeted, 3751, 3685),
    Function.ability(774, "Effect_Repair_RepairDrone_raw_autocast", raw_autocast, 3751, 3685),
    Function.ability(775, "Effect_Repair_SCV_raw_targeted", raw_targeted, 316, 3685),
    Function.ability(776, "Effect_Repair_SCV_raw_autocast", raw_autocast, 316, 3685),
    Function.ability(777, "Effect_RepairDrone_raw_pos", raw_pos, 3749),
    Function.ability(778, "Effect_Restore_raw_targeted", raw_targeted, 3765),
    Function.ability(779, "Effect_Restore_raw_autocast", raw_autocast, 3765),
    Function.ability(780, "Effect_Salvage_raw_quick", raw_quick, 32),
    Function.ability(781, "Effect_Scan_raw_pos", raw_pos, 399),
    Function.ability(782, "Effect_SpawnChangeling_raw_quick", raw_quick, 181),
    Function.ability(783, "Effect_SpawnLocusts_raw_pos", raw_pos, 2704),
    Function.ability(784, "Effect_Spray_raw_pos", raw_pos, 3684),
    Function.ability(785, "Effect_Spray_Protoss_raw_pos", raw_pos, 30, 3684),
    Function.ability(786, "Effect_Spray_Terran_raw_pos", raw_pos, 26, 3684),
    Function.ability(787, "Effect_Spray_Zerg_raw_pos", raw_pos, 28, 3684),
    Function.ability(788, "Effect_Stim_raw_quick", raw_quick, 3675),
    Function.ability(789, "Effect_Stim_Marauder_raw_quick", raw_quick, 253, 3675),
    Function.ability(790, "Effect_Stim_Marauder_Redirect_raw_quick", raw_quick, 1684, 3675),
    Function.ability(791, "Effect_Stim_Marine_raw_quick", raw_quick, 380, 3675),
    Function.ability(792, "Effect_Stim_Marine_Redirect_raw_quick", raw_quick, 1683, 3675),
    Function.ability(793, "Effect_SupplyDrop_raw_targeted", raw_targeted, 255),
    Function.ability(794, "Effect_TacticalJump_raw_pos", raw_pos, 2358),
    Function.ability(795, "Effect_TimeWarp_raw_pos", raw_pos, 2244),
    Function.ability(796, "Effect_Transfusion_raw_targeted", raw_targeted, 1664),
    Function.ability(797, "Effect_ViperConsume_raw_targeted", raw_targeted, 2073),
    Function.ability(798, "Effect_VoidRayPrismaticAlignment_raw_quick", raw_quick, 2393),
    Function.ability(799, "Effect_WidowMineAttack_raw_targeted", raw_targeted, 2099),
    Function.ability(800, "Effect_WidowMineAttack_raw_autocast", raw_autocast, 2099),
    Function.ability(801, "Effect_YamatoGun_raw_targeted", raw_targeted, 401),
    Function.ability(802, "Hallucination_Adept_raw_quick", raw_quick, 2391),
    Function.ability(803, "Hallucination_Archon_raw_quick", raw_quick, 146),
    Function.ability(804, "Hallucination_Colossus_raw_quick", raw_quick, 148),
    Function.ability(805, "Hallucination_Disruptor_raw_quick", raw_quick, 2389),
    Function.ability(806, "Hallucination_HighTemplar_raw_quick", raw_quick, 150),
    Function.ability(807, "Hallucination_Immortal_raw_quick", raw_quick, 152),
    Function.ability(808, "Hallucination_Oracle_raw_quick", raw_quick, 2114),
    Function.ability(809, "Hallucination_Phoenix_raw_quick", raw_quick, 154),
    Function.ability(810, "Hallucination_Probe_raw_quick", raw_quick, 156),
    Function.ability(811, "Hallucination_Stalker_raw_quick", raw_quick, 158),
    Function.ability(812, "Hallucination_VoidRay_raw_quick", raw_quick, 160),
    Function.ability(813, "Hallucination_WarpPrism_raw_quick", raw_quick, 162),
    Function.ability(814, "Hallucination_Zealot_raw_quick", raw_quick, 164),
    Function.ability(815, "Halt_raw_quick", raw_quick, 3660),
    Function.ability(816, "Halt_Building_raw_quick", raw_quick, 315, 3660),
    Function.ability(817, "Halt_TerranBuild_raw_quick", raw_quick, 348, 3660),
    Function.ability(818, "Harvest_Gather_raw_targeted", raw_targeted, 3666),
    Function.ability(819, "Harvest_Gather_Drone_raw_targeted", raw_targeted, 1183, 3666),
    Function.ability(820, "Harvest_Gather_Mule_raw_targeted", raw_targeted, 166, 3666),
    Function.ability(821, "Harvest_Gather_Probe_raw_targeted", raw_targeted, 298, 3666),
    Function.ability(822, "Harvest_Gather_SCV_raw_targeted", raw_targeted, 295, 3666),
    Function.ability(823, "Harvest_Return_raw_quick", raw_quick, 3667),
    Function.ability(824, "Harvest_Return_Drone_raw_quick", raw_quick, 1184, 3667),
    Function.ability(825, "Harvest_Return_Mule_raw_quick", raw_quick, 167, 3667),
    Function.ability(826, "Harvest_Return_Probe_raw_quick", raw_quick, 299, 3667),
    Function.ability(827, "Harvest_Return_SCV_raw_quick", raw_quick, 296, 3667),
    Function.ability(828, "HoldPosition_raw_quick", raw_quick, 18),
    Function.ability(829, "Land_raw_pos", raw_pos, 3678),
    Function.ability(830, "Land_Barracks_raw_pos", raw_pos, 554, 3678),
    Function.ability(831, "Land_CommandCenter_raw_pos", raw_pos, 419, 3678),
    Function.ability(832, "Land_Factory_raw_pos", raw_pos, 520, 3678),
    Function.ability(833, "Land_OrbitalCommand_raw_pos", raw_pos, 1524, 3678),
    Function.ability(834, "Land_Starport_raw_pos", raw_pos, 522, 3678),
    Function.ability(835, "Lift_raw_quick", raw_quick, 3679),
    Function.ability(836, "Lift_Barracks_raw_quick", raw_quick, 452, 3679),
    Function.ability(837, "Lift_CommandCenter_raw_quick", raw_quick, 417, 3679),
    Function.ability(838, "Lift_Factory_raw_quick", raw_quick, 485, 3679),
    Function.ability(839, "Lift_OrbitalCommand_raw_quick", raw_quick, 1522, 3679),
    Function.ability(840, "Lift_Starport_raw_quick", raw_quick, 518, 3679),
    Function.ability(841, "Load_raw_targeted", raw_targeted, 3668),
    Function.ability(842, "Load_Bunker_raw_targeted", raw_targeted, 407, 3668),
    Function.ability(843, "Load_Medivac_raw_targeted", raw_targeted, 394, 3668),
    Function.ability(844, "Load_NydusNetwork_raw_targeted", raw_targeted, 1437, 3668),
    Function.ability(845, "Load_NydusWorm_raw_targeted", raw_targeted, 2370, 3668),
    Function.ability(846, "Load_Overlord_raw_targeted", raw_targeted, 1406, 3668),
    Function.ability(847, "Load_WarpPrism_raw_targeted", raw_targeted, 911, 3668),
    Function.ability(848, "LoadAll_raw_quick", raw_quick, 3663),
    Function.ability(849, "LoadAll_CommandCenter_raw_quick", raw_quick, 416, 3663),
    Function.ability(850, "Morph_Archon_raw_quick", raw_quick, 1766),
    Function.ability(851, "Morph_BroodLord_raw_quick", raw_quick, 1372),
    Function.ability(852, "Morph_Gateway_raw_quick", raw_quick, 1520),
    Function.ability(853, "Morph_GreaterSpire_raw_quick", raw_quick, 1220),
    Function.ability(854, "Morph_Hellbat_raw_quick", raw_quick, 1998),
    Function.ability(855, "Morph_Hellion_raw_quick", raw_quick, 1978),
    Function.ability(856, "Morph_Hive_raw_quick", raw_quick, 1218),
    Function.ability(857, "Morph_Lair_raw_quick", raw_quick, 1216),
    Function.ability(858, "Morph_LiberatorAAMode_raw_quick", raw_quick, 2560),
    Function.ability(859, "Morph_LiberatorAGMode_raw_pos", raw_pos, 2558),
    Function.ability(860, "Morph_Lurker_raw_quick", raw_quick, 2332),
    Function.ability(861, "Morph_LurkerDen_raw_quick", raw_quick, 2112),
    Function.ability(862, "Morph_Mothership_raw_quick", raw_quick, 1847),
    Function.ability(863, "Morph_ObserverMode_raw_quick", raw_quick, 3739),
    Function.ability(864, "Morph_OrbitalCommand_raw_quick", raw_quick, 1516),
    Function.ability(865, "Morph_OverlordTransport_raw_quick", raw_quick, 2708),
    Function.ability(866, "Morph_Overseer_raw_quick", raw_quick, 1448),
    Function.ability(867, "Morph_OverseerMode_raw_quick", raw_quick, 3745),
    Function.ability(868, "Morph_OversightMode_raw_quick", raw_quick, 3743),
    Function.ability(869, "Morph_PlanetaryFortress_raw_quick", raw_quick, 1450),
    Function.ability(870, "Morph_Ravager_raw_quick", raw_quick, 2330),
    Function.ability(871, "Morph_Root_raw_pos", raw_pos, 3680),
    Function.ability(872, "Morph_SpineCrawlerRoot_raw_pos", raw_pos, 1729, 3680),
    Function.ability(873, "Morph_SporeCrawlerRoot_raw_pos", raw_pos, 1731, 3680),
    Function.ability(874, "Morph_SiegeMode_raw_quick", raw_quick, 388),
    Function.ability(875, "Morph_SupplyDepot_Lower_raw_quick", raw_quick, 556),
    Function.ability(876, "Morph_SupplyDepot_Raise_raw_quick", raw_quick, 558),
    Function.ability(877, "Morph_SurveillanceMode_raw_quick", raw_quick, 3741),
    Function.ability(878, "Morph_ThorExplosiveMode_raw_quick", raw_quick, 2364),
    Function.ability(879, "Morph_ThorHighImpactMode_raw_quick", raw_quick, 2362),
    Function.ability(880, "Morph_Unsiege_raw_quick", raw_quick, 390),
    Function.ability(881, "Morph_Uproot_raw_quick", raw_quick, 3681),
    Function.ability(882, "Morph_SpineCrawlerUproot_raw_quick", raw_quick, 1725, 3681),
    Function.ability(883, "Morph_SporeCrawlerUproot_raw_quick", raw_quick, 1727, 3681),
    Function.ability(884, "Morph_VikingAssaultMode_raw_quick", raw_quick, 403),
    Function.ability(885, "Morph_VikingFighterMode_raw_quick", raw_quick, 405),
    Function.ability(886, "Morph_WarpGate_raw_quick", raw_quick, 1518),
    Function.ability(887, "Morph_WarpGate_raw_autocast", raw_autocast, 1518),
    Function.ability(888, "Morph_WarpPrismPhasingMode_raw_quick", raw_quick, 1528),
    Function.ability(889, "Morph_WarpPrismTransportMode_raw_quick", raw_quick, 1530),
    Function.ability(890, "Move_raw_pos", raw_pos, 16),
    Function.ability(891, "Move_raw_targeted", raw_targeted, 16),
    Function.ability(892, "Patrol_raw_pos", raw_pos, 17),
    Function.ability(893, "Patrol_raw_targeted", raw_targeted, 17),
    Function.ability(894, "Rally_Units_raw_pos", raw_pos, 3673),
    Function.ability(895, "Rally_Units_raw_targeted", raw_targeted, 3673),
    Function.ability(896, "Rally_Building_raw_pos", raw_pos, 195, 3673),
    Function.ability(897, "Rally_Building_raw_targeted", raw_targeted, 195, 3673),
    Function.ability(898, "Rally_Hatchery_Units_raw_pos", raw_pos, 211, 3673),
    Function.ability(899, "Rally_Hatchery_Units_raw_targeted", raw_targeted, 211, 3673),
    Function.ability(900, "Rally_Morphing_Unit_raw_pos", raw_pos, 199, 3673),
    Function.ability(901, "Rally_Morphing_Unit_raw_targeted", raw_targeted, 199, 3673),
    Function.ability(902, "Rally_Workers_raw_pos", raw_pos, 3690),
    Function.ability(903, "Rally_Workers_raw_targeted", raw_targeted, 3690),
    Function.ability(904, "Rally_CommandCenter_raw_pos", raw_pos, 203, 3690),
    Function.ability(905, "Rally_CommandCenter_raw_targeted", raw_targeted, 203, 3690),
    Function.ability(906, "Rally_Hatchery_Workers_raw_pos", raw_pos, 212, 3690),
    Function.ability(907, "Rally_Hatchery_Workers_raw_targeted", raw_targeted, 212, 3690),
    Function.ability(908, "Rally_Nexus_raw_pos", raw_pos, 207, 3690),
    Function.ability(909, "Rally_Nexus_raw_targeted", raw_targeted, 207, 3690),
    Function.ability(910, "Research_AdaptiveTalons_raw_quick", raw_quick, 3709),
    Function.ability(911, "Research_AdeptResonatingGlaives_raw_quick", raw_quick, 1594),
    Function.ability(912, "Research_AdvancedBallistics_raw_quick", raw_quick, 805),
    Function.ability(913, "Research_BansheeCloakingField_raw_quick", raw_quick, 790),
    Function.ability(914, "Research_BansheeHyperflightRotors_raw_quick", raw_quick, 799),
    Function.ability(915, "Research_BattlecruiserWeaponRefit_raw_quick", raw_quick, 1532),
    Function.ability(916, "Research_Blink_raw_quick", raw_quick, 1593),
    Function.ability(917, "Research_Burrow_raw_quick", raw_quick, 1225),
    Function.ability(918, "Research_CentrifugalHooks_raw_quick", raw_quick, 1482),
    Function.ability(919, "Research_Charge_raw_quick", raw_quick, 1592),
    Function.ability(920, "Research_ChitinousPlating_raw_quick", raw_quick, 265),
    Function.ability(921, "Research_CombatShield_raw_quick", raw_quick, 731),
    Function.ability(922, "Research_ConcussiveShells_raw_quick", raw_quick, 732),
    Function.ability(923, "Research_CycloneRapidFireLaunchers_raw_quick", raw_quick, 768),
    Function.ability(924, "Research_DrillingClaws_raw_quick", raw_quick, 764),
    Function.ability(925, "Research_ExtendedThermalLance_raw_quick", raw_quick, 1097),
    Function.ability(926, "Research_GlialRegeneration_raw_quick", raw_quick, 216),
    Function.ability(927, "Research_GraviticBooster_raw_quick", raw_quick, 1093),
    Function.ability(928, "Research_GraviticDrive_raw_quick", raw_quick, 1094),
    Function.ability(929, "Research_GroovedSpines_raw_quick", raw_quick, 1282),
    Function.ability(930, "Research_HiSecAutoTracking_raw_quick", raw_quick, 650),
    Function.ability(931, "Research_HighCapacityFuelTanks_raw_quick", raw_quick, 804),
    Function.ability(932, "Research_InfernalPreigniter_raw_quick", raw_quick, 761),
    Function.ability(933, "Research_InterceptorGravitonCatapult_raw_quick", raw_quick, 44),
    Function.ability(934, "Research_MuscularAugments_raw_quick", raw_quick, 1283),
    Function.ability(935, "Research_NeosteelFrame_raw_quick", raw_quick, 655),
    Function.ability(936, "Research_NeuralParasite_raw_quick", raw_quick, 1455),
    Function.ability(937, "Research_PathogenGlands_raw_quick", raw_quick, 1454),
    Function.ability(938, "Research_PersonalCloaking_raw_quick", raw_quick, 820),
    Function.ability(939, "Research_PhoenixAnionPulseCrystals_raw_quick", raw_quick, 46),
    Function.ability(940, "Research_PneumatizedCarapace_raw_quick", raw_quick, 1223),
    Function.ability(941, "Research_ProtossAirArmor_raw_quick", raw_quick, 3692),
    Function.ability(942, "Research_ProtossAirArmorLevel1_raw_quick", raw_quick, 1565, 3692),
    Function.ability(943, "Research_ProtossAirArmorLevel2_raw_quick", raw_quick, 1566, 3692),
    Function.ability(944, "Research_ProtossAirArmorLevel3_raw_quick", raw_quick, 1567, 3692),
    Function.ability(945, "Research_ProtossAirWeapons_raw_quick", raw_quick, 3693),
    Function.ability(946, "Research_ProtossAirWeaponsLevel1_raw_quick", raw_quick, 1562, 3693),
    Function.ability(947, "Research_ProtossAirWeaponsLevel2_raw_quick", raw_quick, 1563, 3693),
    Function.ability(948, "Research_ProtossAirWeaponsLevel3_raw_quick", raw_quick, 1564, 3693),
    Function.ability(949, "Research_ProtossGroundArmor_raw_quick", raw_quick, 3694),
    Function.ability(950, "Research_ProtossGroundArmorLevel1_raw_quick", raw_quick, 1065, 3694),
    Function.ability(951, "Research_ProtossGroundArmorLevel2_raw_quick", raw_quick, 1066, 3694),
    Function.ability(952, "Research_ProtossGroundArmorLevel3_raw_quick", raw_quick, 1067, 3694),
    Function.ability(953, "Research_ProtossGroundWeapons_raw_quick", raw_quick, 3695),
    Function.ability(954, "Research_ProtossGroundWeaponsLevel1_raw_quick", raw_quick, 1062, 3695),
    Function.ability(955, "Research_ProtossGroundWeaponsLevel2_raw_quick", raw_quick, 1063, 3695),
    Function.ability(956, "Research_ProtossGroundWeaponsLevel3_raw_quick", raw_quick, 1064, 3695),
    Function.ability(957, "Research_ProtossShields_raw_quick", raw_quick, 3696),
    Function.ability(958, "Research_ProtossShieldsLevel1_raw_quick", raw_quick, 1068, 3696),
    Function.ability(959, "Research_ProtossShieldsLevel2_raw_quick", raw_quick, 1069, 3696),
    Function.ability(960, "Research_ProtossShieldsLevel3_raw_quick", raw_quick, 1070, 3696),
    Function.ability(961, "Research_PsiStorm_raw_quick", raw_quick, 1126),
    Function.ability(962, "Research_RavenCorvidReactor_raw_quick", raw_quick, 793),
    Function.ability(963, "Research_RavenRecalibratedExplosives_raw_quick", raw_quick, 803),
    Function.ability(964, "Research_ShadowStrike_raw_quick", raw_quick, 2720),
    Function.ability(965, "Research_SmartServos_raw_quick", raw_quick, 766),
    Function.ability(966, "Research_Stimpack_raw_quick", raw_quick, 730),
    Function.ability(967, "Research_TerranInfantryArmor_raw_quick", raw_quick, 3697),
    Function.ability(968, "Research_TerranInfantryArmorLevel1_raw_quick", raw_quick, 656, 3697),
    Function.ability(969, "Research_TerranInfantryArmorLevel2_raw_quick", raw_quick, 657, 3697),
    Function.ability(970, "Research_TerranInfantryArmorLevel3_raw_quick", raw_quick, 658, 3697),
    Function.ability(971, "Research_TerranInfantryWeapons_raw_quick", raw_quick, 3698),
    Function.ability(972, "Research_TerranInfantryWeaponsLevel1_raw_quick", raw_quick, 652, 3698),
    Function.ability(973, "Research_TerranInfantryWeaponsLevel2_raw_quick", raw_quick, 653, 3698),
    Function.ability(974, "Research_TerranInfantryWeaponsLevel3_raw_quick", raw_quick, 654, 3698),
    Function.ability(975, "Research_TerranShipWeapons_raw_quick", raw_quick, 3699),
    Function.ability(976, "Research_TerranShipWeaponsLevel1_raw_quick", raw_quick, 861, 3699),
    Function.ability(977, "Research_TerranShipWeaponsLevel2_raw_quick", raw_quick, 862, 3699),
    Function.ability(978, "Research_TerranShipWeaponsLevel3_raw_quick", raw_quick, 863, 3699),
    Function.ability(979, "Research_TerranStructureArmorUpgrade_raw_quick", raw_quick, 651),
    Function.ability(980, "Research_TerranVehicleAndShipPlating_raw_quick", raw_quick, 3700),
    Function.ability(981, "Research_TerranVehicleAndShipPlatingLevel1_raw_quick", raw_quick, 864, 3700),
    Function.ability(982, "Research_TerranVehicleAndShipPlatingLevel2_raw_quick", raw_quick, 865, 3700),
    Function.ability(983, "Research_TerranVehicleAndShipPlatingLevel3_raw_quick", raw_quick, 866, 3700),
    Function.ability(984, "Research_TerranVehicleWeapons_raw_quick", raw_quick, 3701),
    Function.ability(985, "Research_TerranVehicleWeaponsLevel1_raw_quick", raw_quick, 855, 3701),
    Function.ability(986, "Research_TerranVehicleWeaponsLevel2_raw_quick", raw_quick, 856, 3701),
    Function.ability(987, "Research_TerranVehicleWeaponsLevel3_raw_quick", raw_quick, 857, 3701),
    Function.ability(988, "Research_TunnelingClaws_raw_quick", raw_quick, 217),
    Function.ability(989, "Research_WarpGate_raw_quick", raw_quick, 1568),
    Function.ability(990, "Research_ZergFlyerArmor_raw_quick", raw_quick, 3702),
    Function.ability(991, "Research_ZergFlyerArmorLevel1_raw_quick", raw_quick, 1315, 3702),
    Function.ability(992, "Research_ZergFlyerArmorLevel2_raw_quick", raw_quick, 1316, 3702),
    Function.ability(993, "Research_ZergFlyerArmorLevel3_raw_quick", raw_quick, 1317, 3702),
    Function.ability(994, "Research_ZergFlyerAttack_raw_quick", raw_quick, 3703),
    Function.ability(995, "Research_ZergFlyerAttackLevel1_raw_quick", raw_quick, 1312, 3703),
    Function.ability(996, "Research_ZergFlyerAttackLevel2_raw_quick", raw_quick, 1313, 3703),
    Function.ability(997, "Research_ZergFlyerAttackLevel3_raw_quick", raw_quick, 1314, 3703),
    Function.ability(998, "Research_ZergGroundArmor_raw_quick", raw_quick, 3704),
    Function.ability(999, "Research_ZergGroundArmorLevel1_raw_quick", raw_quick, 1189, 3704),
    Function.ability(1000, "Research_ZergGroundArmorLevel2_raw_quick", raw_quick, 1190, 3704),
    Function.ability(1001, "Research_ZergGroundArmorLevel3_raw_quick", raw_quick, 1191, 3704),
    Function.ability(1002, "Research_ZergMeleeWeapons_raw_quick", raw_quick, 3705),
    Function.ability(1003, "Research_ZergMeleeWeaponsLevel1_raw_quick", raw_quick, 1186, 3705),
    Function.ability(1004, "Research_ZergMeleeWeaponsLevel2_raw_quick", raw_quick, 1187, 3705),
    Function.ability(1005, "Research_ZergMeleeWeaponsLevel3_raw_quick", raw_quick, 1188, 3705),
    Function.ability(1006, "Research_ZergMissileWeapons_raw_quick", raw_quick, 3706),
    Function.ability(1007, "Research_ZergMissileWeaponsLevel1_raw_quick", raw_quick, 1192, 3706),
    Function.ability(1008, "Research_ZergMissileWeaponsLevel2_raw_quick", raw_quick, 1193, 3706),
    Function.ability(1009, "Research_ZergMissileWeaponsLevel3_raw_quick", raw_quick, 1194, 3706),
    Function.ability(1010, "Research_ZerglingAdrenalGlands_raw_quick", raw_quick, 1252),
    Function.ability(1011, "Research_ZerglingMetabolicBoost_raw_quick", raw_quick, 1253),
    Function.ability(1012, "Smart_raw_pos", raw_pos, 1),
    Function.ability(1013, "Smart_raw_targeted", raw_targeted, 1),
    Function.ability(1014, "Stop_raw_quick", raw_quick, 3665),
    Function.ability(1015, "Stop_Building_raw_quick", raw_quick, 2057, 3665),
    Function.ability(1016, "Stop_Redirect_raw_quick", raw_quick, 1691, 3665),
    Function.ability(1017, "Stop_Stop_raw_quick", raw_quick, 4, 3665),
    Function.ability(1018, "Train_Adept_raw_quick", raw_quick, 922),
    Function.ability(1019, "Train_Baneling_raw_quick", raw_quick, 80),
    Function.ability(1020, "Train_Banshee_raw_quick", raw_quick, 621),
    Function.ability(1021, "Train_Battlecruiser_raw_quick", raw_quick, 623),
    Function.ability(1022, "Train_Carrier_raw_quick", raw_quick, 948),
    Function.ability(1023, "Train_Colossus_raw_quick", raw_quick, 978),
    Function.ability(1024, "Train_Corruptor_raw_quick", raw_quick, 1353),
    Function.ability(1025, "Train_Cyclone_raw_quick", raw_quick, 597),
    Function.ability(1026, "Train_DarkTemplar_raw_quick", raw_quick, 920),
    Function.ability(1027, "Train_Disruptor_raw_quick", raw_quick, 994),
    Function.ability(1028, "Train_Drone_raw_quick", raw_quick, 1342),
    Function.ability(1029, "Train_Ghost_raw_quick", raw_quick, 562),
    Function.ability(1030, "Train_Hellbat_raw_quick", raw_quick, 596),
    Function.ability(1031, "Train_Hellion_raw_quick", raw_quick, 595),
    Function.ability(1032, "Train_HighTemplar_raw_quick", raw_quick, 919),
    Function.ability(1033, "Train_Hydralisk_raw_quick", raw_quick, 1345),
    Function.ability(1034, "Train_Immortal_raw_quick", raw_quick, 979),
    Function.ability(1035, "Train_Infestor_raw_quick", raw_quick, 1352),
    Function.ability(1036, "Train_Liberator_raw_quick", raw_quick, 626),
    Function.ability(1037, "Train_Marauder_raw_quick", raw_quick, 563),
    Function.ability(1038, "Train_Marine_raw_quick", raw_quick, 560),
    Function.ability(1039, "Train_Medivac_raw_quick", raw_quick, 620),
    Function.ability(1040, "Train_Mothership_raw_quick", raw_quick, 110),
    Function.ability(1041, "Train_MothershipCore_raw_quick", raw_quick, 1853),
    Function.ability(1042, "Train_Mutalisk_raw_quick", raw_quick, 1346),
    Function.ability(1043, "Train_Observer_raw_quick", raw_quick, 977),
    Function.ability(1044, "Train_Oracle_raw_quick", raw_quick, 954),
    Function.ability(1045, "Train_Overlord_raw_quick", raw_quick, 1344),
    Function.ability(1046, "Train_Phoenix_raw_quick", raw_quick, 946),
    Function.ability(1047, "Train_Probe_raw_quick", raw_quick, 1006),
    Function.ability(1048, "Train_Queen_raw_quick", raw_quick, 1632),
    Function.ability(1049, "Train_Raven_raw_quick", raw_quick, 622),
    Function.ability(1050, "Train_Reaper_raw_quick", raw_quick, 561),
    Function.ability(1051, "Train_Roach_raw_quick", raw_quick, 1351),
    Function.ability(1052, "Train_SCV_raw_quick", raw_quick, 524),
    Function.ability(1053, "Train_Sentry_raw_quick", raw_quick, 921),
    Function.ability(1054, "Train_SiegeTank_raw_quick", raw_quick, 591),
    Function.ability(1055, "Train_Stalker_raw_quick", raw_quick, 917),
    Function.ability(1056, "Train_SwarmHost_raw_quick", raw_quick, 1356),
    Function.ability(1057, "Train_Tempest_raw_quick", raw_quick, 955),
    Function.ability(1058, "Train_Thor_raw_quick", raw_quick, 594),
    Function.ability(1059, "Train_Ultralisk_raw_quick", raw_quick, 1348),
    Function.ability(1060, "Train_VikingFighter_raw_quick", raw_quick, 624),
    Function.ability(1061, "Train_Viper_raw_quick", raw_quick, 1354),
    Function.ability(1062, "Train_VoidRay_raw_quick", raw_quick, 950),
    Function.ability(1063, "Train_WarpPrism_raw_quick", raw_quick, 976),
    Function.ability(1064, "Train_WidowMine_raw_quick", raw_quick, 614),
    Function.ability(1065, "Train_Zealot_raw_quick", raw_quick, 916),
    Function.ability(1066, "Train_Zergling_raw_quick", raw_quick, 1343),
    Function.ability(1067, "TrainWarp_Adept_raw_pos", raw_pos, 1419),
    Function.ability(1068, "TrainWarp_DarkTemplar_raw_pos", raw_pos, 1417),
    Function.ability(1069, "TrainWarp_HighTemplar_raw_pos", raw_pos, 1416),
    Function.ability(1070, "TrainWarp_Sentry_raw_pos", raw_pos, 1418),
    Function.ability(1071, "TrainWarp_Stalker_raw_pos", raw_pos, 1414),
    Function.ability(1072, "TrainWarp_Zealot_raw_pos", raw_pos, 1413),
    Function.ability(1073, "UnloadAll_raw_quick", raw_quick, 3664),
    Function.ability(1074, "UnloadAll_Bunker_raw_quick", raw_quick, 408, 3664),
    Function.ability(1075, "UnloadAll_CommandCenter_raw_quick", raw_quick, 413, 3664),
    Function.ability(1076, "UnloadAll_NydasNetwork_raw_quick", raw_quick, 1438, 3664),
    Function.ability(1077, "UnloadAll_NydusWorm_raw_quick", raw_quick, 2371, 3664),
    Function.ability(1078, "UnloadAllAt_raw_pos", raw_pos, 3669),
    Function.ability(1079, "UnloadAllAt_raw_targeted", raw_targeted, 3669),
    Function.ability(1080, "UnloadAllAt_Medivac_raw_pos", raw_pos, 396, 3669),
    Function.ability(1081, "UnloadAllAt_Medivac_raw_targeted", raw_targeted, 396, 3669),
    Function.ability(1082, "UnloadAllAt_Overlord_raw_pos", raw_pos, 1408, 3669),
    Function.ability(1083, "UnloadAllAt_Overlord_raw_targeted", raw_targeted, 1408, 3669),
    Function.ability(1084, "UnloadAllAt_WarpPrism_raw_pos", raw_pos, 913, 3669),
    Function.ability(1085, "UnloadAllAt_WarpPrism_raw_targeted", raw_targeted, 913, 3669),
]
